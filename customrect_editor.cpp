...
#include "ui_customrect_editor.h"

CustomRect_Editor::CustomRect_Editor(int width,int height,QColor color,QColor lineColor,int lineThickness,int rotation, int borderRadius) :
    QDialog(),
    ui(new Ui::CustomRect_Editor)
{
    ui->setupUi(this);
...
CustomRect_Editor::~CustomRect_Editor()
{
    delete ui;
}

void CustomRect_Editor::on_rotationDial_valueChanged(int value)
{
    ui->rotationLineEdit->setText( QString::number(value));
    saveChanges();
}

void CustomRect_Editor::on_rotationLineEdit_textChanged(const QString &arg1)
{
    ui->rotationDial->setValue(arg1.toInt());
    saveChanges();
}

void CustomRect_Editor::on_sizeSliderWidth_valueChanged(int value)
{
    ui->widthSizeLineEdit->setText(QString::number(value));
    saveChanges();
}

void CustomRect_Editor::on_widthSizeLineEdit_textChanged(const QString &arg1)
{
    ui->sizeSliderWidth->setValue(arg1.toInt());
    saveChanges();
}

void CustomRect_Editor::on_sizeSliderHeight_valueChanged(int value)
{
    ui->heigthSizeLineEdit->setText(QString::number(value));
    saveChanges();
}

void CustomRect_Editor::on_heigthSizeLineEdit_textChanged(const QString &arg1)
{
    ui->sizeSliderHeight->setValue(arg1.toInt());
    saveChanges();
}

void CustomRect_Editor::on_sizeSliderLineThickness_valueChanged(int value)
{
    ui->lineThicknessSizeLineEdit_2->setText(QString::number(value));
    saveChanges();
}

void CustomRect_Editor::on_lineThicknessSizeLineEdit_2_textChanged(const QString &arg1)
{
    ui->sizeSliderLineThickness->setValue(arg1.toInt());
    saveChanges();
}

void CustomRect_Editor::saveChanges()
{
...
void CustomRect_Editor::on_colorPicker_clicked()
{
...
void CustomRect_Editor::on_pushButton_clicked()
{
...
void CustomRect_Editor::on_sizeSliderBorderRadius_valueChanged(int value)
{
    ui->borderRadiusLineEdit->setText(QString::number(value));
    saveChanges();
}

void CustomRect_Editor::on_borderRadiusLineEdit_textChanged(const QString &arg1)
{
